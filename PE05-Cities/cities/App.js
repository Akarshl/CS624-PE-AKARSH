...
function CountriesStackScreen({ navigation, route, countries, addCountry, addLandmark }) {
  return (
    <Stack.Navigator
      screenOptions={{
        headerStyle: { backgroundColor: colors.primary },
    ...
    >
      <Stack.Screen
        name="Countries"
        children={(props) => (
          <Countries {...props} countries={countries} addCountry={addCountry} addLandmark={addLandmark} />
        )}
      />
      <Stack.Screen
        name="Country"
        children={(props) => (
          <Country {...props} countries={countries} addCountry={addCountry} addLandmark={addLandmark} />
        )}
      />
    </Stack.Navigator>
  );
...
export default class App extends Component {
  ...
  addCountry = (country) => {
    this.setState((prevState) => ({
      countries: [...prevState.countries, { ...country, landmarks: [] }],
    }));
  };
  ...
  addLandmark = (landmark, country) => {
    ...
    const updatedCountry = {
      ...
      landmarks: [...this.state.countries[index].landmarks, landmark],
    };
    const countries = [
